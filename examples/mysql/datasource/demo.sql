...
INSERT INTO `demo` (`id`, `name`, `firstname`, `age`, `height`, `continent`, `country`, `email`, `freelance`, `lastvisit`, `website`) VALUES
(1, 'Hoffman', 'Silly Name', 88, 1.32, 'as', 'AE', 'Nam@quisdiamluctus.org', 1, '2012-04-17', 'www.qktogkjbsvz.rdh'),
...
(10, 'Schultz', 'Frederic', 20, 1.70, 'eu', 'be', 'Fusce.feugiat.Lorem@Duis.net', 1, '2012-05-03', 'www.itpfwatjnov.nix'),
